...
start       = 1;
offset      = [0 200 434 675 777 888] + start - 1; % starting point for
...
%             [rx_bits{i_user}, temp]  = bitDemap(rx{i_user}, bits_per_symb(i_user), VarN(i_user, i_ebNo));
    ...
    mat_file_name = strcat('results/SL_Nu6_Nt4_Nr2_PA_SNR_', num2str(EbNo(i_ebNo)), '.mat');
